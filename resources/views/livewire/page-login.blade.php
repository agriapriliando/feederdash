<div>
    ...
    <div class="mb-5 sm:mb-8">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
            Selamat Datang di FeederDash (Dashboard Neo Feeder)
        </p>
    </div>
    <div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div x-data="{ showPassword: false }" class="relative">
                        <input autocomplete="off" wire:model="password" :type="showPassword ? 'text' : 'password'" placeholder="Enter your password"
