...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
                ...
                <nav x-data="{ selected: 'Dashboard' }">
                    ...
                    <div>
                        ...
                        <ul class="flex flex-col gap-4 mb-6">
                            <!-- Menu Item Mahasiswa -->
                            <li>
                                <a wire:navigate href="{{ route('mahasiswa.index') }}" @click="selected = 'Mahasiswa'" class="menu-item group"
                                    :class="(selected === 'Mahasiswa') ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg :class="(selected === 'Mahasiswa') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <!-- Menu Item Prodi -->
                            <li>
                                <a wire:navigate href="{{ route('prodi.index') }}" @click="selected = 'Prodi'" class="menu-item group"
                                    :class="(selected === 'Prodi') ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg :class="(selected === 'Prodi') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z"
                                            fill="" />
                            ...
                            <!-- Menu Item Grafik -->
                            <li>
                                <a href="{{ route('grafik.index') }}" @click="selected = 'Grafik'" class="menu-item group"
                                    :class="(selected === 'Grafik') ? 'menu-item-active' : 'menu-item-inactive'">
                                    <svg :class="(selected === 'Grafik') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" class="size-6">
                ...
                <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                    ...
                    <div :class="menuToggle ? 'flex' : 'hidden'" class="shadow-theme-md w-full items-center justify-between gap-4 px-5 py-4 lg:flex lg:justify-end lg:px-0 lg:shadow-none">
                        <div class="2xsm:gap-3 flex items-center gap-2">
                            ...
                            <div class="hidden relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                                <button
                                    class="hover:text-dark-900 relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                            <a class="flex items-center text-gray-700 dark:text-gray-400" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                                <span class="text-theme-base mr-1 block font-medium"> Agri </span>
                                ...
                                <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                                    <li>
                                        <a href="profile.html"
                                            ...
                                            <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24"
    ...
    {{-- <script src="https://cdn.jsdelivr.net/npm/@alpinejs/persist@3.15.0/dist/cdn.min.js"></script> --}}
    @stack('chartjs')
</body>
